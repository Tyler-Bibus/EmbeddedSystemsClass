...
filename = 'graphThis.txt' # Name of sensor data file
...
ax.set_rmax(0.75)                    # Saturate distance at 2.5 meters
ax.set_rticks([0.25, 0.5, 0.75])   # Set plot "distance" tick marks at .5, 1, 1.5, 2, and 2.5 meters
